...
export default function EditColaboradorForm({ colaborador }: Props) {
  ...
  // fundador(a) com cargo "Administrador", fora da lista fixa de cargos
  // e só alcançável via cargo em texto livre) — campo opcional, mostrado
  // pra todo mundo em vez de travado por uma lista que sempre vai deixar
  // alguém de fora.
    ...
    <form action={formAction} className="space-y-8" noValidate>
      ...
      <div className="space-y-4">
        ...
        <p className="font-body text-xs text-muted">
          ...
          Meta 2, e assim por diante. Deixe em branco para não usar metas.
        </p>
        <div className="mt-2 grid grid-cols-1 gap-4 sm:grid-cols-3">
          <div className="rounded-lg border border-border p-3 space-y-2">
            ...
            <Field label="Comissão no mês (R$)">
              <input
                ...
                min="0"
                step="0.01"
                defaultValue={colaborador.meta1_valor ?? ""}
                placeholder="Ex: 5000"
                disabled={isPending}
                className={inputClass}
              />
            ...
            <Field label="Bônus (R$)">
              <input
                ...
                min="0"
                step="0.01"
                defaultValue={colaborador.meta1_bonus ?? ""}
                placeholder="Ex: 300"
                disabled={isPending}
                className={inputClass}
              />
          ...
          <div className="rounded-lg border border-border p-3 space-y-2">
            ...
            <Field label="Comissão no mês (R$)">
              <input
                ...
                min="0"
                step="0.01"
                defaultValue={colaborador.meta2_valor ?? ""}
                placeholder="Ex: 8000"
                disabled={isPending}
                className={inputClass}
              />
            ...
            <Field label="Bônus (R$)">
              <input
                ...
                min="0"
                step="0.01"
                defaultValue={colaborador.meta2_bonus ?? ""}
                placeholder="Ex: 600"
                disabled={isPending}
                className={inputClass}
              />
          ...
          <div className="rounded-lg border border-border p-3 space-y-2">
            ...
            <Field label="Comissão no mês (R$)">
              <input
                ...
                min="0"
                step="0.01"
                defaultValue={colaborador.meta3_valor ?? ""}
            ...
            <Field label="Bônus (R$)">
              <input
                ...
                min="0"
                step="0.01"
                defaultValue={colaborador.meta3_bonus ?? ""}
                placeholder="Ex: 1200"
                disabled={isPending}
                className={inputClass}
              />
