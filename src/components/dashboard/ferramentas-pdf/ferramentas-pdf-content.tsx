...
const FERRAMENTAS: Ferramenta[] = [
  ...
  },
  {
    ...
    descricao:
      "Divide o PDF por tipo de documento com Inteligência Artificial (TramitaIA)",
    href: "/pdfs/dividir/novo?tipo=ia",
    icone: <IconSparkles />,
    badge: "IA",
  },
];
