...
const CID_CATEGORIAS: Record<string, string> = {
  ...
  M41: "Escoliose",
  M43: "Outras dorsopatias deformantes (espondilolistese)",
  M45: "Espondilite ancilosante",
  M47: "Espondilose",
  M48: "Outras espondilopatias (estenose de canal vertebral)",
  ...
  M65: "Sinovite e tenossinovite (LER/DORT)",
  M67: "Outros transtornos de sinóvia e tendão",
  M70: "Transtornos de tecidos moles relacionados ao uso, sobrecarga e pressão (LER/DORT)",
  M72: "Transtornos fibroblásticos (Dupuytren)",
  M75: "Lesões do ombro",
  M76: "Entesopatias do membro inferior (exclui pé)",
  M77: "Outras entesopatias (epicondilite, esporão de calcâneo)",
  ...
  M84: "Transtornos da continuidade óssea (pseudoartrose, fratura de estresse)",
