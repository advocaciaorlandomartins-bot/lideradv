...
export const MODULOS = [
  ...
  {
    key: "clientes_ver_todos",
    label: "Clientes — Ver todos (não só os próprios)",
    parent: null,
  },
  ...
  {
    key: "processos_ver_todos",
    label: "Processos — Ver todos (não só os próprios)",
    parent: null,
  },
  ...
  { key: "controladoria", label: "Controladoria", parent: null },
...
export const DEFAULTS_POR_CATEGORIA: Record<string, Permissoes> = {
  "Administrador(a)": {
    ...
    producao: FULL,
    clientes: FULL,
    clientes_ver_todos: FULL,
    processos: FULL,
    processos_responsavel: FULL,
    processos_ver_todos: FULL,
    publicacoes: FULL,
    financeiro: FULL,
    controles: FULL,
    assinaturas: FULL,
  ...
  "Advogado(a)": {
    ...
    clientes_ver_todos: NONE,
    processos: FULL,
    processos_responsavel: NONE,
    processos_ver_todos: NONE,
    publicacoes: FULL,
    financeiro: VER,
    controles: FULL,
    assinaturas: FULL,
